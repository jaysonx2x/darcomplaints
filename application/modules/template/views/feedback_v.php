        ...
        <div class="card feedback-card mb-3">
            ...
            <div class="form-section" >
                <form id="feedback_form" method="post" action="#">
                    ...
                    <p>This Client Satisfaction Measurement (CSM) tracks the customer experience of government offices. Your feedback will help us provide better service. Personal information shared will remain confidential.</p>
                    ...
                    <hr>
                    <h5 class="text-success mt-3">Citizen’s Charter (CC) Questions</h5>
                    <div class="row mt-3">
                        <div class="col-md-12">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label><strong>CC2. <small class="text-danger">*</small></strong> If aware of CC, would you say that the CC of this office was...?</label>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label><strong>CC3. <small class="text-danger">*</small></strong> If aware of CC, how much did it help you in your transaction?</label>
                        </div>
                        <div class="col-md-5 ml-3">
                            <div class="custom-control custom-radio">
                    ...
                    <hr>
                    <h5 class="text-success mt-3">Service Quality Dimensions (SQD)</h5>
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody style="font-size: 10pt;">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD2.</b> The office followed the transaction’s steps based on the CC.</td>
                                <td>
                                    <div class="custom-control custom-radio">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD3.</b> The steps for my transaction were easy and simple.</td>
                                <td>
                                    <div class="custom-control custom-radio">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD4.</b> I easily found information about my transaction.</td>
                                <td>
                                    <div class="custom-control custom-radio">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD5.</b> I paid a reasonable amount of fees.</td>
                                <td>
                                    <div class="custom-control custom-radio">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD6.</b> The office was fair to everyone (“walang palakasan”).</td>
                                <td>
                                    <div class="custom-control custom-radio">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD7.</b> Staff were courteous and helpful.</td>
                                <td>
                                    <div class="custom-control custom-radio">
                            ...
                            <tr>
                                <td class="text-left"><b>SQD8.</b> I got what I needed / denial was explained to me.</td>
                                <td>
                                    <div class="custom-control custom-radio">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-success px-5"><i class="fa fa-paper-plane"></i> Submit</button>
                    </div>
                </form>
            </div>
        </div>
