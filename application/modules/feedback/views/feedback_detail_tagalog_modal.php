        ...
        <div class="modal fade" id="feedback_detail_tagalog_modal" data-backdrop="static" data-keyboard="false" tabindex="-1">
            ...
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php $this->load->view('template/partial/feedback_tagalog', array('view_only' => true)); ?>
