        ...
        <div class="modal fade" id="feedback_form_modal" data-backdrop="static" data-keyboard="false" tabindex="-1">
                ...
                <div class="modal-content">
                    ...
                    <form id="feedback_form" method="post" action="#">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group input-group-sm col-md-3">
                                    ...
                                    <input type="date" id="feedback_date" name="feedback_date" 
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Add Feedback</button>
