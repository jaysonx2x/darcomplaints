                            ...
                            ><table style="padding: 2px; font-size: 10pt;" >
                                <thead>
                                    <tr>
                                        ...
                                        <th width="30%" class="table-th border-bottom-gray border-top-gray border-right-gray border-left-gray text-center">Company</th>
                                        <th width="25%" class="table-th border-bottom-gray border-top-gray border-right-gray border-left-gray text-center">User Type</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                    ...
                                    ?>
                                                <tr>
                                                    ...
                                                    <td class="table-td border-bottom-gray border-top-gray border-right-gray border-left-gray"><?php echo fn_format_user_type($report->user_type); ?></td>
                                                </tr>
                                    <?php 
                                            }
                                        } else { 
