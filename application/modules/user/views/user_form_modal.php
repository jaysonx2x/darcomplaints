...
<div class="modal fade" id="user_form_modal" data-backdrop="static" data-keyboard="false" tabindex="-1">
                ...
                <div class="modal-body p-b-0">
                    ...
                    <div class="row hidden">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="id" name="id" readonly value="0">
                                ...
                                <input type="text" id="IS_PASSW_EDITED" name="IS_PASSW_EDITED" class="form-control" value="1" readonly >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 text-center">
                            <div class="card rounded-card user-card">
                                <div class="card-block p-r-0 p-l-0">
                                    <div class="img-hover">
                                        <div id="the_camera">
                                            <img id="profile_picture" class="img-fluid" style="width: 80%;" src="<?php echo base_url('assets/img/no-image.png'); ?>" alt="round-img">
                                        </div>
                    ...
                    <div class="row">
                        <div class="form-group input-group-sm col-md-4">
                            ...
                            <input type="text" class="form-control" placeholder="Username" id="username" name="username" maxlength="45">
                        ...
                        <div class="form-group input-group-sm col-md-4 PASSW_CONTAINER">
